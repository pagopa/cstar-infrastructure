...
--
-- Name: bpd_payment_instrument_tmp; Type: SCHEMA; Schema: -; Owner: ddsadmin
--

CREATE SCHEMA bpd_payment_instrument_tmp;


ALTER SCHEMA bpd_payment_instrument_tmp OWNER TO ddsadmin;
...
--
-- Name: bpd_winning_transaction_tmp; Type: SCHEMA; Schema: -; Owner: ddsadmin
--

CREATE SCHEMA bpd_winning_transaction_tmp;


ALTER SCHEMA bpd_winning_transaction_tmp OWNER TO ddsadmin;
...
GRANT USAGE ON SCHEMA bpd_award_period TO "BPD_PAYMENT_INSTRUMENT_REMOTE_USER";
...
GRANT USAGE ON SCHEMA bpd_dashboard_pagopa TO "MONITORING_USER";
...
GRANT USAGE ON SCHEMA bpd_mcc_category TO "DASHBOARD_PAGOPA_USER";
...
GRANT USAGE ON SCHEMA bpd_payment_instrument_tmp TO "BPD_PAYMENT_INSTRUMENT_REMOTE_USER";
GRANT ALL ON SCHEMA bpd_payment_instrument_tmp TO "BPD_USER";
GRANT USAGE ON SCHEMA bpd_payment_instrument_tmp TO "DASHBOARD_PAGOPA_USER";
GRANT USAGE ON SCHEMA bpd_payment_instrument_tmp TO "MONITORING_USER";
...
GRANT ALL ON SCHEMA bpd_winning_transaction_tmp TO "BPD_USER";
GRANT USAGE ON SCHEMA bpd_winning_transaction_tmp TO "BPD_WINNING_TRANSACTION_REMOTE_USER";
GRANT USAGE ON SCHEMA bpd_winning_transaction_tmp TO "DASHBOARD_PAGOPA_USER";
GRANT USAGE ON SCHEMA bpd_winning_transaction_tmp TO "MONITORING_USER";
...
--
-- Name: data_preparation_milestone(); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.data_preparation_milestone() OWNER TO ddsadmin;
...
--
-- Name: test_bonifica(bigint); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.test_bonifica(off bigint) OWNER TO ddsadmin;

--
-- Name: test_bonifica(bigint, bigint); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.test_bonifica(awp bigint, off bigint) OWNER TO ddsadmin;

--
-- Name: test_ranking_old_new(integer); Type: FUNCTION; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER FUNCTION bpd_citizen.test_ranking_old_new(i integer) OWNER TO "BPD_USER";

--
-- Name: update_bonifica_recesso_citizen(character varying); Type: FUNCTION; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER FUNCTION bpd_citizen.update_bonifica_recesso_citizen(citizen_range character varying) OWNER TO "BPD_USER";
...
begin
	...
	ON conflict on constraint bpd_award_winner_pk DO nothing;
...
--
-- Name: update_bpd_award_winner_tmp(bigint); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--

CREATE FUNCTION bpd_citizen.update_bpd_award_winner_tmp(award_period_id bigint) RETURNS void
    LANGUAGE plpgsql
    AS $_$
...
begin
	...
	select
		...
		null as technical_account_holder_s
	from
		bpd_citizen.bpd_citizen_ranking_parimerito bcr
	inner join bpd_citizen.bpd_citizen bc on
		bcr.fiscal_code_c = bc.fiscal_code_s
	inner join bpd_award_period.bpd_award_period bap on
		bcr.award_period_id_n = bap.award_period_id_n
...
ALTER FUNCTION bpd_citizen.update_bpd_award_winner_tmp(award_period_id bigint) OWNER TO ddsadmin;

--
-- Name: update_bpd_citizen_ranking(); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.update_bpd_citizen_ranking() OWNER TO ddsadmin;

--
-- Name: update_bpd_citizen_ranking_old(); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.update_bpd_citizen_ranking_old() OWNER TO ddsadmin;

--
-- Name: update_bpd_citizen_ranking_tmp_new(); Type: FUNCTION; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER FUNCTION bpd_citizen.update_bpd_citizen_ranking_tmp_new() OWNER TO "BPD_USER";

--
-- Name: update_bpd_ranking_ext(bigint, numeric); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.update_bpd_ranking_ext(bigint, numeric) OWNER TO ddsadmin;

--
-- Name: update_ranking_with_milestone(integer, integer); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.update_ranking_with_milestone(in_offset integer, in_limit integer) OWNER TO ddsadmin;
...
--
-- Name: update_ranking_with_milestone_new(integer, integer, timestamp with time zone); Type: FUNCTION; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_citizen.update_ranking_with_milestone_new(in_offset integer, in_limit integer, in_now_timestamp timestamp with time zone) OWNER TO ddsadmin;
...
CREATE FUNCTION bpd_payment_instrument.insert_bpd_payment_instrument_history() RETURNS trigger
    LANGUAGE plpgsql
    AS $$    BEGIN
        INSERT INTO bpd_payment_instrument.bpd_payment_instrument_history(hpan_s, activation_t, deactivation_t, fiscal_code_s, insert_date_t, insert_user_s, update_date_t, update_user_s, channel_s, par_s, par_activation_t, par_deactivation_t)
		VALUES(NEW.hpan_s, NEW.enrollment_t, NULL, NEW.fiscal_code_s, NEW.insert_date_t, NEW.insert_user_s, NEW.update_date_t, NEW.update_user_s, NEW.channel_s, NEW.par_s, NEW.par_enrollment_t, NEW.par_cancellation_t) ON CONFLICT DO NOTHING;
        RETURN NEW;
    END;
$$;
...
CREATE FUNCTION bpd_payment_instrument.update_bpd_payment_instrument_history() RETURNS trigger
    ...
    AS $$    
			BEGIN
				...
				SET deactivation_t=NEW.cancellation_t, update_date_t=NEW.update_date_t, update_user_s=NEW.update_user_s,par_activation_t=NEW.par_enrollment_t,par_deactivation_t=NEW.par_cancellation_t
...
--
-- Name: find_citizen_milestones_new(character varying, integer, numeric, integer); Type: FUNCTION; Schema: bpd_winning_transaction; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_winning_transaction.find_citizen_milestones_new(in_fiscal_code character varying, in_award_period integer, in_max_cashback_period numeric, in_trx_volume_min_n integer) OWNER TO ddsadmin;

--
-- Name: get_citizen_transactions(text, bigint, text); Type: FUNCTION; Schema: bpd_winning_transaction; Owner: ddsadmin
--
...
ALTER FUNCTION bpd_winning_transaction.get_citizen_transactions(in_fiscal_code text, in_award_period bigint, in_hpan text) OWNER TO ddsadmin;
...
--
-- Name: datapreparation20210625(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--
...
ALTER FUNCTION public.datapreparation20210625() OWNER TO "BPD_USER";

--
-- Name: datapreparation20210625_upd(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--
...
ALTER FUNCTION public.datapreparation20210625_upd() OWNER TO "BPD_USER";

--
-- Name: datapreparation20210626(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--
...
ALTER FUNCTION public.datapreparation20210626() OWNER TO "BPD_USER";

--
-- Name: datapreparation20210628(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--

CREATE FUNCTION public.datapreparation20210628() RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
	cur_cf_ranking refcursor;
	...
	countervar int := 0;
 	...
 	begin
		open cur_cf_ranking for execute 
			'select fiscal_code_c from bpd_citizen.bpd_citizen_ranking_parimerito bcrp where last_trx_timestamp_t is null;'; -- where ranking_n is null ;  ';
		raise notice 'cur_cf_ranking';
		...
		loop
			...
			update bpd_citizen.bpd_citizen_ranking_parimerito
			set 
			last_trx_timestamp_t = now() - ('1 second'::interval * floor(random() * 13800000 + 1000))
			where fiscal_code_c = fiscalCode_cp;
...
ALTER FUNCTION public.datapreparation20210628() OWNER TO "BPD_USER";

--
-- Name: datapreparation20210628_bywinntx(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--

CREATE FUNCTION public.datapreparation20210628_bywinntx() RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
	cur_cf CURSOR(PARaward_period_id int) for select fiscal_code_s, trx_timestamp_t from bpd_winning_transaction.bpd_winning_transaction bwt where award_period_id_n = PARaward_period_id;	 
	fiscalCode_c varchar;
	trxtimestamp timestamptz;
	countervar int := 0;
	CURRENTaward_period_id int := 1;
	countervar2 int := 0;
	begin
		open cur_cf(PARaward_period_id := CURRENTaward_period_id);
		raise notice 'eseguita cur_cf';		
		loop
			countervar = countervar + 1;
			fetch cur_cf into fiscalCode_c, trxtimestamp;
			exit when not found;

		    	update bpd_citizen.bpd_citizen_ranking_parimerito 
				set last_trx_timestamp_t = trxtimestamp
				where fiscal_code_c = fiscalCode_c
				and award_period_id_n = CURRENTaward_period_id
				and coalesce(last_trx_timestamp_t, '2000-01-01 00:00:00') < trxtimestamp;
...
ALTER FUNCTION public.datapreparation20210628_bywinntx() OWNER TO "BPD_USER";

--
-- Name: datapreparation20210628_dstribuzionetx(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--

CREATE FUNCTION public.datapreparation20210628_dstribuzionetx() RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
	cur_cf CURSOR(PARaward_period_id int) for select fiscal_code_s from bpd_winning_transaction.bpd_winning_transaction bwt where award_period_id_n = PARaward_period_id and fiscal_code_s in('ATIFSN02T06F213P', 'CGCAAN50P10C086W','EXIKVT32T19F804M', 'JSXGNL49M24G833B',	'ESPUMY77A27F058K',	'CMYQRS77R22A466W',	'RAYDTS83S13D410T', 'VZGAKW38E16I853X');	 
	cur_cf_ranking CURSOR(PARaward_period_id int) for select fiscal_code_c from bpd_citizen.bpd_citizen_ranking_parimerito bcr where award_period_id_n = PARaward_period_id;
	fiscalCode_c varchar;
	fiscalCode_ranking varchar;
	countervar int := 0;
	CURRENTaward_period_id int := 1;
	countervar2 int := 0;
	begin
		open cur_cf(PARaward_period_id := CURRENTaward_period_id);
		raise notice 'eseguita cur_cf';		
		open cur_cf_ranking(PARaward_period_id := CURRENTaward_period_id);
		raise notice 'cur_cf_ranking;'	;
		loop
			countervar = countervar + 1;
			fetch cur_cf into fiscalCode_c;
			...
			fetch cur_cf_ranking into fiscalCode_ranking;
			if not found then
				close cur_cf_ranking;
				open cur_cf_ranking(PARaward_period_id := CURRENTaward_period_id);
				fetch cur_cf_ranking into fiscalCode_ranking;
			end if;
		
			update bpd_winning_transaction.bpd_winning_transaction  set fiscal_code_s = fiscalCode_ranking	where current of cur_cf;
				
			if (countervar > 50000)  then
				countervar2 = countervar2 + 1;
				raise notice '50000 %', countervar2;
				countervar = 0;
				if(countervar2 >= 140) then 
					exit;
				end if;
		    end if;
		end loop;
...
ALTER FUNCTION public.datapreparation20210628_dstribuzionetx() OWNER TO "BPD_USER";

--
-- Name: datapreparation20210628_preprod(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--

CREATE FUNCTION public.datapreparation20210628_preprod() RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
       cur_cf CURSOR(PARaward_period_id int) for select fiscal_code_c from bpd_citizen.bpd_citizen_ranking_parimerito bc where award_period_id_n = PARaward_period_id and last_trx_timestamp_t is null and fiscal_code_c  not in( 'ATIFSN02T06F213P','CGCAAN50P10C086W','EXIKVT32T19F804M','JSXGNL49M24G833B','ESPUMY77A27F058K','CMYQRS77R22A466W','RAYDTS83S13D410T','VZGAKW38E16I853X');      
       selectMaxTimestamp CURSOR(PAR_fiscal_code_c varchar, PAR_aw_period_n int) FOR select max(trx_timestamp_t) as max_date from bpd_winning_transaction.bpd_winning_transaction bwt where bwt.fiscal_code_s = PAR_fiscal_code_c and bwt.award_period_id_n = PAR_aw_period_n;
       ...
       begin
             ...
             loop
                    ...
                    exit when not found;
             update bpd_citizen.bpd_citizen_ranking_parimerito
                    set last_trx_timestamp_t = (select max(trx_timestamp_t) as max_date from bpd_winning_transaction.bpd_winning_transaction bwt where
                    bwt.fiscal_code_s = fiscalCode_c and bwt.award_period_id_n = CURRENTaward_period_id)
                    where fiscal_code_c = fiscalCode_c
                    and award_period_id_n = CURRENTaward_period_id;
...
ALTER FUNCTION public.datapreparation20210628_preprod() OWNER TO "BPD_USER";

--
-- Name: datapreparation20210628_preprod(integer); Type: FUNCTION; Schema: public; Owner: ddsadmin
--

CREATE FUNCTION public.datapreparation20210628_preprod(in_limit integer DEFAULT 100000) RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
       cur_cf CURSOR(PARaward_period_id int, PAR_limit int) for select fiscal_code_c from bpd_citizen.bpd_citizen_ranking_parimerito bc where award_period_id_n = PARaward_period_id and last_trx_timestamp_t is null limit PAR_limit;      
       selectMaxTimestamp CURSOR(PAR_fiscal_code_c varchar, PAR_aw_period_n int) FOR select max(trx_timestamp_t) as max_date from bpd_winning_transaction.bpd_winning_transaction bwt where bwt.fiscal_code_s = PAR_fiscal_code_c and bwt.award_period_id_n = PAR_aw_period_n;
      
       fiscalCode_c varchar;
       countervar int := 0;
       CURRENTaward_period_id int := 2;
       countervar2 int := 0;
       maxTimestamp timestamptz;
       begin
             open cur_cf(PARaward_period_id := CURRENTaward_period_id, PAR_limit := in_limit);
             raise notice 'eseguita cur_cf';       
             loop
                    countervar = countervar + 1;
                    fetch cur_cf into fiscalCode_c;
...
ALTER FUNCTION public.datapreparation20210628_preprod(in_limit integer) OWNER TO ddsadmin;

--
-- Name: datapreparation20210628_preprod_v2(integer); Type: FUNCTION; Schema: public; Owner: ddsadmin
--

CREATE FUNCTION public.datapreparation20210628_preprod_v2(in_limit integer DEFAULT 100000) RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
       cur_cf CURSOR(PARaward_period_id int, PAR_limit int) for select fiscal_code_c from bpd_citizen.bpd_citizen_ranking_parimerito bc where award_period_id_n = PARaward_period_id and last_trx_timestamp_t is null limit PAR_limit;      
       ...
       maxTimestamp timestamptz;
       begin
	       open cur_cf(PARaward_period_id := CURRENTaward_period_id, PAR_limit := 1);
	      loop
	      	fetch cur_cf into fiscalCode_c;
	      	exit when not found;
	      	countervar = countervar + 1;
	    ...
	    raise notice 'eseguito check presenza';  
	     ...
	     countervar:=0;
             ...
             loop
                   ...
                   raise notice 'Pre-update CF %', fiscalCode_c;
                  
                  
                  select coalesce(max(trx_timestamp_t),'2020-01-01 00:00:00') into maxTimestamp from bpd_winning_transaction.bpd_winning_transaction bwt where
                    bwt.fiscal_code_s = fiscalCode_c and bwt.award_period_id_n = CURRENTaward_period_id;
                  
             	update bpd_citizen.bpd_citizen_ranking_parimerito
                    set last_trx_timestamp_t = maxTimestamp
                    where fiscal_code_c = fiscalCode_c
                    and award_period_id_n = CURRENTaward_period_id;
                   
                   raise notice 'Post-update CF %', fiscalCode_c;
            ...
            raise notice 'Aggiornati %', countervar;
             return 'OK';
       end;
$$;


ALTER FUNCTION public.datapreparation20210628_preprod_v2(in_limit integer) OWNER TO ddsadmin;

--
-- Name: datapreparation20210628_settimestampesatto(); Type: FUNCTION; Schema: public; Owner: BPD_USER
--

CREATE FUNCTION public.datapreparation20210628_settimestampesatto() RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
	cur_cf CURSOR(PARaward_period_id int) for select fiscal_code_s from bpd_winning_transaction.bpd_winning_transaction bwt where award_period_id_n = PARaward_period_id;	 
	fiscalCode_c varchar;
	countervar int := 0;
	CURRENTaward_period_id int := 1;
	countervar2 int := 0;
...
ALTER FUNCTION public.datapreparation20210628_settimestampesatto() OWNER TO "BPD_USER";

--
-- Name: update_last_trx_timestamp(integer, integer); Type: FUNCTION; Schema: public; Owner: ddsadmin
--

CREATE FUNCTION public.update_last_trx_timestamp(award_period_id integer, in_limit integer DEFAULT 100000) RETURNS text
    LANGUAGE plpgsql
    AS $$
declare
       cur_cf CURSOR(PARaward_period_id int, PAR_limit int) for select fiscal_code_c from bpd_citizen.bpd_citizen_ranking bc where award_period_id_n = PARaward_period_id and last_trx_timestamp_t is null limit PAR_limit;      
       selectMaxTimestamp CURSOR(PAR_fiscal_code_c varchar, PAR_aw_period_n int) FOR select max(trx_timestamp_t) as max_date from bpd_winning_transaction.bpd_winning_transaction bwt where bwt.fiscal_code_s = PAR_fiscal_code_c and bwt.award_period_id_n = PAR_aw_period_n;
      
       fiscalCode_c varchar;
       countervar int := 0;
       CURRENTaward_period_id int := award_period_id;
       countervar2 int := 0;
       maxTimestamp timestamptz;
       begin
	       open cur_cf(PARaward_period_id := CURRENTaward_period_id, PAR_limit := 1);
	    ...
	    raise notice 'eseguito check presenza';  
	     ...
	     countervar:=0;
             ...
             loop
             	...
             	update bpd_citizen.bpd_citizen_ranking
                    set last_trx_timestamp_t = (select coalesce(max(trx_timestamp_t),'2020-01-01 00:00:00') as max_date from bpd_winning_transaction.bpd_winning_transaction bwt where
                    bwt.fiscal_code_s = fiscalCode_c and bwt.award_period_id_n = CURRENTaward_period_id)
                    where fiscal_code_c = fiscalCode_c
                    and award_period_id_n = CURRENTaward_period_id;
...
ALTER FUNCTION public.update_last_trx_timestamp(award_period_id integer, in_limit integer) OWNER TO ddsadmin;
...
--
-- Name: bpd_award_period_bck; Type: TABLE; Schema: bpd_award_period; Owner: ddsadmin
--
...
ALTER TABLE bpd_award_period.bpd_award_period_bck OWNER TO ddsadmin;
...
--
-- Name: bpd_award_bpd_ward_id_seq; Type: SEQUENCE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.bpd_award_bpd_ward_id_seq OWNER TO ddsadmin;
...
--
-- Name: bpd_citizen_deleted; Type: TABLE; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER TABLE bpd_citizen.bpd_citizen_deleted OWNER TO "BPD_USER";

--
-- Name: bpd_citizen_notenabled; Type: TABLE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.bpd_citizen_notenabled OWNER TO ddsadmin;
...
--
-- Name: bpd_citizen_ranking_bck; Type: TABLE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.bpd_citizen_ranking_bck OWNER TO ddsadmin;

--
-- Name: bpd_citizen_ranking_deleted; Type: TABLE; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER TABLE bpd_citizen.bpd_citizen_ranking_deleted OWNER TO "BPD_USER";
...
--
-- Name: bpd_citizen_ranking_new; Type: TABLE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.bpd_citizen_ranking_new OWNER TO ddsadmin;

--
-- Name: bpd_citizen_ranking_parimerito; Type: TABLE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.bpd_citizen_ranking_parimerito OWNER TO ddsadmin;

--
-- Name: bpd_citizen_ranking_recovery; Type: TABLE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.bpd_citizen_ranking_recovery OWNER TO ddsadmin;
...
--
-- Name: bpd_elab_transaction_temp; Type: TABLE; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER TABLE bpd_citizen.bpd_elab_transaction_temp OWNER TO "BPD_USER";
...
--
-- Name: bpd_ranking_ext_new; Type: TABLE; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER TABLE bpd_citizen.bpd_ranking_ext_new OWNER TO "BPD_USER";
...
--
-- Name: bpd_ranking_processor_lock_new; Type: TABLE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.bpd_ranking_processor_lock_new OWNER TO ddsadmin;

--
-- Name: bpd_temp_citizen; Type: TABLE; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER TABLE bpd_citizen.bpd_temp_citizen OWNER TO "BPD_USER";
...
--
-- Name: redis_cache_config; Type: TABLE; Schema: bpd_citizen; Owner: ddsadmin
--
...
ALTER TABLE bpd_citizen.redis_cache_config OWNER TO ddsadmin;
...
--
-- Name: temp_citizen_and_pay; Type: TABLE; Schema: bpd_citizen; Owner: BPD_USER
--
...
ALTER TABLE bpd_citizen.temp_citizen_and_pay OWNER TO "BPD_USER";
...
--
-- Name: v_bpd_award_citizen_v2; Type: VIEW; Schema: bpd_dashboard_pagopa; Owner: ddsadmin
--
...
--
-- Name: v_bpd_citizen_v2; Type: VIEW; Schema: bpd_dashboard_pagopa; Owner: ddsadmin
--
...
ALTER TABLE bpd_dashboard_pagopa.v_bpd_citizen_v2 OWNER TO ddsadmin;
...
--
-- Name: v_bpd_winning_transaction_v2; Type: VIEW; Schema: bpd_dashboard_pagopa; Owner: ddsadmin
--
...
ALTER TABLE bpd_dashboard_pagopa.v_bpd_winning_transaction_v2 OWNER TO ddsadmin;
...
--
-- Name: bpd_mcc_category_rel; Type: TABLE; Schema: bpd_mcc_category; Owner: ddsadmin
--
...
ALTER TABLE bpd_mcc_category.bpd_mcc_category_rel OWNER TO ddsadmin;
...
--
-- Name: tmp_payment_instrument; Type: TABLE; Schema: bpd_payment_instrument; Owner: ddsadmin
--
...
ALTER TABLE bpd_payment_instrument.tmp_payment_instrument OWNER TO ddsadmin;

--
-- Name: bpd_payment_instrument; Type: TABLE; Schema: bpd_payment_instrument_tmp; Owner: ddsadmin
--
...
ALTER TABLE bpd_payment_instrument_tmp.bpd_payment_instrument OWNER TO ddsadmin;

--
-- Name: bpd_citizen_status_data; Type: TABLE; Schema: bpd_winning_transaction; Owner: BPD_USER
--
...
ALTER TABLE bpd_winning_transaction.bpd_citizen_status_data OWNER TO "BPD_USER";

--
-- Name: bpd_fiscal_code_performance_tmp; Type: TABLE; Schema: bpd_winning_transaction; Owner: BPD_USER
--
...
ALTER TABLE bpd_winning_transaction.bpd_fiscal_code_performance_tmp OWNER TO "BPD_USER";

--
-- Name: bpd_winning_transaction_p2; Type: TABLE; Schema: bpd_winning_transaction; Owner: ddsadmin
--

CREATE TABLE bpd_winning_transaction.bpd_winning_transaction_p2 (
    acquirer_c character varying(20),
    trx_timestamp_t timestamp with time zone,
    hpan_s character varying(64),
    operation_type_c character varying(5),
...
ALTER TABLE bpd_winning_transaction.bpd_winning_transaction_p2 OWNER TO ddsadmin;

--
-- Name: bpd_winning_transaction_recovery; Type: TABLE; Schema: bpd_winning_transaction; Owner: ddsadmin
--
...
ALTER TABLE bpd_winning_transaction.bpd_winning_transaction_recovery OWNER TO ddsadmin;
...
--
-- Name: select hpan_s, fiscal_code_s  from bpd_payment_instrument.bpd_p; Type: TABLE; Schema: bpd_winning_transaction; Owner: BPD_USER
--
...
ALTER TABLE bpd_winning_transaction."select hpan_s, fiscal_code_s
from bpd_payment_instrument.bpd_p" OWNER TO "BPD_USER";

--
-- Name: temp_hpan_nft; Type: TABLE; Schema: bpd_winning_transaction; Owner: BPD_USER
--
...
ALTER TABLE bpd_winning_transaction.temp_hpan_nft OWNER TO "BPD_USER";

--
-- Name: bpd_winning_transaction; Type: TABLE; Schema: bpd_winning_transaction_tmp; Owner: ddsadmin
--
...
ALTER TABLE bpd_winning_transaction_tmp.bpd_winning_transaction OWNER TO ddsadmin;

--
-- Name: bpd_winning_transaction_transfer; Type: TABLE; Schema: bpd_winning_transaction_tmp; Owner: ddsadmin
--
...
ALTER TABLE bpd_winning_transaction_tmp.bpd_winning_transaction_transfer OWNER TO ddsadmin;

--
-- Name: stress_test_runs; Type: TABLE; Schema: public; Owner: ddsadmin
--
...
ALTER TABLE public.stress_test_runs OWNER TO ddsadmin;

--
-- Name: stress_test_runs_202106101000; Type: TABLE; Schema: public; Owner: ddsadmin
--
...
ALTER TABLE public.stress_test_runs_202106101000 OWNER TO ddsadmin;

--
-- Name: test; Type: TABLE; Schema: public; Owner: ddsadmin
--
...
ALTER TABLE public.test OWNER TO ddsadmin;

--
-- Name: test_temp; Type: TABLE; Schema: public; Owner: ddsadmin
--
...
ALTER TABLE public.test_temp OWNER TO ddsadmin;

--
-- Name: test_y2006m02; Type: TABLE; Schema: public; Owner: ddsadmin
--
...
ALTER TABLE public.test_y2006m02 OWNER TO ddsadmin;

--
-- Name: test_y2006m03; Type: TABLE; Schema: public; Owner: ddsadmin
--
...
ALTER TABLE public.test_y2006m03 OWNER TO ddsadmin;
...
--
-- Name: SCHEMA bpd_payment_instrument_tmp; Type: ACL; Schema: -; Owner: ddsadmin
--
...
--
-- Name: SCHEMA bpd_winning_transaction_tmp; Type: ACL; Schema: -; Owner: ddsadmin
--
...
--
-- Name: FUNCTION data_preparation_milestone(); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.data_preparation_milestone() TO "BPD_USER";
...
--
-- Name: FUNCTION test_bonifica(off bigint); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.test_bonifica(off bigint) TO "BPD_USER";


--
-- Name: FUNCTION test_bonifica(awp bigint, off bigint); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.test_bonifica(awp bigint, off bigint) TO "BPD_USER";
...
--
-- Name: FUNCTION update_bpd_award_winner_tmp(award_period_id bigint); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.update_bpd_award_winner_tmp(award_period_id bigint) TO "BPD_USER";


--
-- Name: FUNCTION update_bpd_citizen_ranking(); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.update_bpd_citizen_ranking() TO "BPD_USER";


--
-- Name: FUNCTION update_bpd_citizen_ranking_old(); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.update_bpd_citizen_ranking_old() TO "BPD_USER";


--
-- Name: FUNCTION update_bpd_ranking_ext(bigint, numeric); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.update_bpd_ranking_ext(bigint, numeric) TO "BPD_USER";


--
-- Name: FUNCTION update_ranking_with_milestone(in_offset integer, in_limit integer); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.update_ranking_with_milestone(in_offset integer, in_limit integer) TO "BPD_USER";
...
--
-- Name: FUNCTION update_ranking_with_milestone_new(in_offset integer, in_limit integer, in_now_timestamp timestamp with time zone); Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_citizen.update_ranking_with_milestone_new(in_offset integer, in_limit integer, in_now_timestamp timestamp with time zone) TO "BPD_USER";
...
--
-- Name: FUNCTION find_citizen_milestones_new(in_fiscal_code character varying, in_award_period integer, in_max_cashback_period numeric, in_trx_volume_min_n integer); Type: ACL; Schema: bpd_winning_transaction; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_winning_transaction.find_citizen_milestones_new(in_fiscal_code character varying, in_award_period integer, in_max_cashback_period numeric, in_trx_volume_min_n integer) TO "BPD_USER";


--
-- Name: FUNCTION get_citizen_transactions(in_fiscal_code text, in_award_period bigint, in_hpan text); Type: ACL; Schema: bpd_winning_transaction; Owner: ddsadmin
--

GRANT ALL ON FUNCTION bpd_winning_transaction.get_citizen_transactions(in_fiscal_code text, in_award_period bigint, in_hpan text) TO "BPD_USER";
...
--
-- Name: FUNCTION datapreparation20210628_preprod(in_limit integer); Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON FUNCTION public.datapreparation20210628_preprod(in_limit integer) TO "BPD_USER";


--
-- Name: FUNCTION datapreparation20210628_preprod_v2(in_limit integer); Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON FUNCTION public.datapreparation20210628_preprod_v2(in_limit integer) TO "BPD_USER";
...
--
-- Name: FUNCTION update_last_trx_timestamp(award_period_id integer, in_limit integer); Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON FUNCTION public.update_last_trx_timestamp(award_period_id integer, in_limit integer) TO "BPD_USER";
...
GRANT SELECT ON TABLE bpd_award_period.bpd_award_period TO "BPD_PAYMENT_INSTRUMENT_REMOTE_USER";
...
--
-- Name: TABLE bpd_award_period_bck; Type: ACL; Schema: bpd_award_period; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_award_period.bpd_award_period_bck TO "BPD_USER";
GRANT SELECT ON TABLE bpd_award_period.bpd_award_period_bck TO "MONITORING_USER";
...
--
-- Name: SEQUENCE bpd_award_bpd_ward_id_seq; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON SEQUENCE bpd_citizen.bpd_award_bpd_ward_id_seq TO "BPD_USER";
...
GRANT SELECT ON TABLE bpd_citizen.bpd_award_winner TO "BPD_PAYMENT_INSTRUMENT_REMOTE_USER";
...
GRANT SELECT ON TABLE bpd_citizen.bpd_citizen TO "DASHBOARD_PAGOPA_USER";


--
-- Name: TABLE bpd_citizen_notenabled; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_citizen.bpd_citizen_notenabled TO "BPD_USER";
GRANT SELECT ON TABLE bpd_citizen.bpd_citizen_notenabled TO "MONITORING_USER";
...
--
-- Name: TABLE bpd_citizen_ranking_bck; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_citizen.bpd_citizen_ranking_bck TO "BPD_USER";
GRANT SELECT ON TABLE bpd_citizen.bpd_citizen_ranking_bck TO "MONITORING_USER";
...
--
-- Name: TABLE bpd_citizen_ranking_new; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_citizen.bpd_citizen_ranking_new TO "BPD_USER";
GRANT SELECT ON TABLE bpd_citizen.bpd_citizen_ranking_new TO "MONITORING_USER";
GRANT SELECT ON TABLE bpd_citizen.bpd_citizen_ranking_new TO "DASHBOARD_PAGOPA_USER";


--
-- Name: TABLE bpd_citizen_ranking_parimerito; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_citizen.bpd_citizen_ranking_parimerito TO "BPD_USER";
GRANT SELECT ON TABLE bpd_citizen.bpd_citizen_ranking_parimerito TO "MONITORING_USER";


--
-- Name: TABLE bpd_citizen_ranking_recovery; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_citizen.bpd_citizen_ranking_recovery TO "BPD_USER";
GRANT SELECT ON TABLE bpd_citizen.bpd_citizen_ranking_recovery TO "MONITORING_USER";
...
--
-- Name: TABLE bpd_ranking_processor_lock_new; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_citizen.bpd_ranking_processor_lock_new TO "BPD_USER";
GRANT SELECT ON TABLE bpd_citizen.bpd_ranking_processor_lock_new TO "MONITORING_USER";
...
GRANT SELECT ON TABLE bpd_citizen.bpd_winning_amount TO "DASHBOARD_PAGOPA_USER";


--
-- Name: TABLE redis_cache_config; Type: ACL; Schema: bpd_citizen; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_citizen.redis_cache_config TO "BPD_USER";
GRANT SELECT ON TABLE bpd_citizen.redis_cache_config TO "MONITORING_USER";
...
--
-- Name: TABLE v_bpd_award_citizen_v2; Type: ACL; Schema: bpd_dashboard_pagopa; Owner: ddsadmin
--
...
GRANT SELECT ON TABLE bpd_payment_instrument.bpd_payment_instrument TO "DASHBOARD_PAGOPA_USER";
...
--
-- Name: TABLE v_bpd_citizen_v2; Type: ACL; Schema: bpd_dashboard_pagopa; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_dashboard_pagopa.v_bpd_citizen_v2 TO "BPD_USER";
GRANT SELECT ON TABLE bpd_dashboard_pagopa.v_bpd_citizen_v2 TO "MONITORING_USER";
...
GRANT SELECT ON TABLE bpd_payment_instrument.bpd_payment_instrument_history TO "DASHBOARD_PAGOPA_USER";
...
GRANT SELECT ON TABLE bpd_winning_transaction.bpd_winning_transaction TO "DASHBOARD_PAGOPA_USER";
...
--
-- Name: TABLE v_bpd_winning_transaction_v2; Type: ACL; Schema: bpd_dashboard_pagopa; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_dashboard_pagopa.v_bpd_winning_transaction_v2 TO "BPD_USER";
GRANT SELECT ON TABLE bpd_dashboard_pagopa.v_bpd_winning_transaction_v2 TO "MONITORING_USER";
...
GRANT SELECT ON TABLE bpd_mcc_category.bpd_mcc_category TO "DASHBOARD_PAGOPA_USER";


--
-- Name: TABLE bpd_mcc_category_rel; Type: ACL; Schema: bpd_mcc_category; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_mcc_category.bpd_mcc_category_rel TO "BPD_USER";
GRANT SELECT ON TABLE bpd_mcc_category.bpd_mcc_category_rel TO "MONITORING_USER";
GRANT SELECT ON TABLE bpd_mcc_category.bpd_mcc_category_rel TO "DASHBOARD_PAGOPA_USER";
...
--
-- Name: TABLE tmp_payment_instrument; Type: ACL; Schema: bpd_payment_instrument; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_payment_instrument.tmp_payment_instrument TO "BPD_USER";


--
-- Name: TABLE bpd_payment_instrument; Type: ACL; Schema: bpd_payment_instrument_tmp; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_payment_instrument_tmp.bpd_payment_instrument TO "BPD_USER";
GRANT SELECT ON TABLE bpd_payment_instrument_tmp.bpd_payment_instrument TO "MONITORING_USER";
GRANT SELECT ON TABLE bpd_payment_instrument_tmp.bpd_payment_instrument TO "BPD_PAYMENT_INSTRUMENT_REMOTE_USER";
GRANT SELECT ON TABLE bpd_payment_instrument_tmp.bpd_payment_instrument TO "DASHBOARD_PAGOPA_USER";


--
-- Name: TABLE bpd_citizen_status_data; Type: ACL; Schema: bpd_winning_transaction; Owner: BPD_USER
--
...
--
-- Name: TABLE bpd_fiscal_code_performance_tmp; Type: ACL; Schema: bpd_winning_transaction; Owner: BPD_USER
--

GRANT SELECT ON TABLE bpd_winning_transaction.bpd_fiscal_code_performance_tmp TO "MONITORING_USER";
GRANT ALL ON TABLE bpd_winning_transaction.bpd_fiscal_code_performance_tmp TO ddsadmin;


--
-- Name: TABLE bpd_winning_transaction_p2; Type: ACL; Schema: bpd_winning_transaction; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_winning_transaction.bpd_winning_transaction_p2 TO "BPD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction.bpd_winning_transaction_p2 TO "RTD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction.bpd_winning_transaction_p2 TO "MONITORING_USER";


--
-- Name: TABLE bpd_winning_transaction_recovery; Type: ACL; Schema: bpd_winning_transaction; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_winning_transaction.bpd_winning_transaction_recovery TO "BPD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction.bpd_winning_transaction_recovery TO "RTD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction.bpd_winning_transaction_recovery TO "MONITORING_USER";
...
GRANT SELECT ON TABLE bpd_winning_transaction.bpd_winning_transaction_transfer TO "RTD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction.bpd_winning_transaction_transfer TO "MONITORING_USER";


--
-- Name: TABLE bpd_winning_transaction; Type: ACL; Schema: bpd_winning_transaction_tmp; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction TO "BPD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction TO "RTD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction TO "MONITORING_USER";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction TO "BPD_WINNING_TRANSACTION_REMOTE_USER";
GRANT SELECT ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction TO "DASHBOARD_PAGOPA_USER";


--
-- Name: TABLE bpd_winning_transaction_transfer; Type: ACL; Schema: bpd_winning_transaction_tmp; Owner: ddsadmin
--

GRANT ALL ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction_transfer TO "BPD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction_transfer TO "RTD_USER";
GRANT SELECT ON TABLE bpd_winning_transaction_tmp.bpd_winning_transaction_transfer TO "MONITORING_USER";


--
-- Name: TABLE stress_test_runs; Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON TABLE public.stress_test_runs TO "BPD_USER";
GRANT SELECT ON TABLE public.stress_test_runs TO "MONITORING_USER";


--
-- Name: TABLE stress_test_runs_202106101000; Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON TABLE public.stress_test_runs_202106101000 TO "BPD_USER";
GRANT SELECT ON TABLE public.stress_test_runs_202106101000 TO "MONITORING_USER";


--
-- Name: TABLE test; Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON TABLE public.test TO "BPD_USER";
GRANT SELECT ON TABLE public.test TO "MONITORING_USER";


--
-- Name: TABLE test_temp; Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON TABLE public.test_temp TO "BPD_USER";
GRANT SELECT ON TABLE public.test_temp TO "MONITORING_USER";


--
-- Name: TABLE test_y2006m02; Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON TABLE public.test_y2006m02 TO "BPD_USER";
GRANT SELECT ON TABLE public.test_y2006m02 TO "MONITORING_USER";


--
-- Name: TABLE test_y2006m03; Type: ACL; Schema: public; Owner: ddsadmin
--

GRANT ALL ON TABLE public.test_y2006m03 TO "BPD_USER";
GRANT SELECT ON TABLE public.test_y2006m03 TO "MONITORING_USER";
