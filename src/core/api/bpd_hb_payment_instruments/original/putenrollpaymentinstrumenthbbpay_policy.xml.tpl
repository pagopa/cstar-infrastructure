    ...
    <inbound>
        <choose>
            <when condition="@(context.Request.Body != null && context.Request.Body.As<JObject>(preserveContent: true)["fiscalCode"] != null)">
                ...
                <set-variable name="cryptedPhoneNumber" value="@(context.Request.Body.As<JObject>(preserveContent: true)["cryptedPhoneNumber"])" />
                        ...
                        return new JObject(
								...
								new JProperty("info",
									new JObject(
                                        ...
                                        new JProperty("numeroTelefonicoCriptato", context.Variables["cryptedPhoneNumber"]),
                                        new JProperty("UIDCriptato", context.Variables["id"]),
                                        new JProperty("statoServizio", context.Variables["serviceStatus"]),
										new JProperty("infoStrumenti", new JArray(new JObject(
