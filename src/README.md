...
| [azurerm_private_endpoint.sftp](https://registry.terraform.io/providers/hashicorp/azurerm/2.99.0/docs/resources/private_endpoint) | resource |
...
| <a name="input_sftp_ip_rules"></a> [sftp\_ip\_rules](#input\_sftp\_ip\_rules) | List of public IP or IP ranges in CIDR Format allowed to access the storage account. Only IPV4 addresses are allowed | `list(string)` | n/a | yes |
| <a name="input_sftp_subnet_id"></a> [sftp\_subnet\_id](#input\_sftp\_subnet\_id) | The ID of the Subnet from which Private IP Addresses will be allocated for the Private Endpoint. | `string` | n/a | yes |
