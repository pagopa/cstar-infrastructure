...
| <a name="input_redis_subnet_id"></a> [redis\_subnet\_id](#input\_redis\_subnet\_id) | The ID of the Subnet within which the Redis Cache should be deployed. | `string` | `null` | no |
