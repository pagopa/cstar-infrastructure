...
resource "azurerm_key_vault_secret" "event_hub_root_key_idpay_00" {
  ...
  value        = "org.apache.kafka.common.security.plain.PlainLoginModule required username=\"$ConnectionString\" password=\"${azurerm_eventhub_namespace_authorization_rule.evh_namespace_access_key_00[0].primary_connection_string}\";"
