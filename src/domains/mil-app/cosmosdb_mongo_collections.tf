...
resource "azurerm_cosmosdb_mongo_collection" "payment_transactions" {
  account_name        = data.azurerm_cosmosdb_mongo_database.mil.account_name
  database_name       = data.azurerm_cosmosdb_mongo_database.mil.name
  name                = "paymentTransactions"
  resource_group_name = data.azurerm_cosmosdb_mongo_database.mil.resource_group_name
