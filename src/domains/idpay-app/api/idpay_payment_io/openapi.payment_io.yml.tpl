      ...
      properties:
        code:
          ...
          description: >-
            ...
            PAYMENT_INITIATIVE_NOT_FOUND: the initiative is not found,
            PAYMENT_INITIATIVE_INVALID_DATE: the user tried to create transaction outside initiative fruition period,
            ...
            PAYMENT_INITIATIVE_INVALID_DATE: l'utente ha provato a creare una transazione al di fuori del periodo di fruizione,
