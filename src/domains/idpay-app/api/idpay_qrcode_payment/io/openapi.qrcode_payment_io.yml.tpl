          ...
          content:
            application/json:
              ...
              example:
                ...
                message: 'transaction not found or expired'
        '412':
                  description: The transaction version mismatch
                  content:
                    application/json:
                      schema:
                        $ref: '#/components/schemas/TransactionErrorDTO'
                      example:
                        code: 'PAYMENT_TRANSACTION_VERSION_MISMATCH'
                        message: 'The transaction version mismatch'
        '423':
                  description: The transaction version is actually locked
                  content:
                    application/json:
                      schema:
                        $ref: '#/components/schemas/TransactionErrorDTO'
                      example:
                        code: 'PAYMENT_TRANSACTION_VERSION_PENDING'
                        message: 'The transaction version is actually locked'
        '429':
          description: Too many Request
          content:
            application/json:
