...
<policies>
    <inbound>
        ...
        <choose>
            ...
            <when condition="@(context.Request.Headers.ContainsKey("organizationId"))">
                <set-variable name="organizationIdHeader" value="@(context.Request.Headers.GetValueOrDefault("organizationId",""))" />
                <choose>
                    <!-- If header not present than HTTP Status 500 -->
