  ...
  "items": [
    {
      "type": 1,
      "content": {
        "json": "### This workbook is intended to show the performance observed during the elaboration of the synchronous evaluation workflow of discount transactions performed by citizens, especially for citizens who have previously joined the initiatives. \r\nFor more functional information about the workflow of discount transactions see:\r\nhttps://pagopa.atlassian.net/wiki/spaces/IDPAY/pages/665387791/Pagamenti+ID+Pay\r\n"
      },
      "name": "text - 2"
    },
    {
        ...
        "items": [
          {
            "type": 1,
            "content": {
              "json": "This section is dedicated to all kafka queues used in this flow.\r\nThe two graphs below show incoming and outgoing messages from the eventhub ${prefix}-idpay-evh-ns-01 filtered by the folowing topic:\r\n\r\n1. idpay-transaction (see design rewiew [Payment] (https://pagopa.atlassian.net/wiki/spaces/IDPAY/pages/665387791/Pagamenti+ID+Pay)).\r\n\r\n\r\n"
            },
            "name": "text - 6"
          },
          {
        ...
        "items": [
          {
            ...
            "content": {
              ...
              "size": 1,
              "showAnalytics": true,
              "title": "Distribution of transaction processing",
              "timeContextFromParameter": "timeRange",
            ...
            "name": "Distribution of transaction processing"
          },
          {
            "type": 1,
            "content": {
          ...
          },
          {
            ...
            "content": {
              ...
              "size": 1,
              "showAnalytics": true,
              "title": "Distribution of single transaction average ms",
              "timeContextFromParameter": "timeRange",
              "timeBrushParameterName": "timeRange",
              "showExportToExcel": true,
              "queryType": 0,
            ...
            "name": "Distribution of single transaction average ms"
          },
          {
            "type": 1,
            "content": {
          ...
          },
          {
            ...
            "customWidth": "50",
            "name": "Distribution of transaction elaboration result",
            "styleSettings": {
              "maxWidth": "50"
            }
          },
