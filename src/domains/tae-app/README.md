...
| <a name="input_cosmos_sink_throughput"></a> [cosmos\_sink\_throughput](#input\_cosmos\_sink\_throughput) | n/a | <pre>object({<br>    cap = number<br>  })</pre> | <pre>{<br>  "cap": 1000<br>}</pre> | no |
