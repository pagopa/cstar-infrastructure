...
cidr_subnet_apim               = ["10.230.4.0/24"]
cidr_subnet_appgateway         = ["10.230.5.0/24"]
cidr_subnet_azdoa              = ["10.0.250.0/24"]
cidr_subnet_db                 = ["10.230.6.0/24"]
cidr_subnet_eventhub           = ["10.230.7.0/24"]
cidr_subnet_jumpbox            = ["10.230.2.0/24"]
cidr_subnet_k8s                = ["10.230.0.0/23"]
cidr_vnet                      = ["10.230.7.0/21"]
